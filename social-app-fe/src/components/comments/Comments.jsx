...
export default function Comments({ commentDetail }) {
    const username = Users.filter((u) => u.id === commentDetail.userId)[0].username;
    const userAvatar = Users.filter((u) => u.id === commentDetail.userId)[0].userAvatar;
    return (
        <>
                ...
                <li className="comment">
                    ...
                    <div className="commentUsers">
                        ...
                        <ul className="commentUserOptions">
                            ...
                            <li className="commentUserTimes">{timeDiff(new Date().getTime(), commentDetail.times)}</li>
                        </ul>
                    </div>
                </li>
            </ul>
