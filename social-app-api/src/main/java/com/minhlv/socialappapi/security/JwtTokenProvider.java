...
public class JwtTokenProvider {
    ...
    private static final String JWT_SECRET_DEV = Base64.getEncoder().encodeToString("123456".getBytes());
    private static final String JWT_SECRET_PROD = Base64.getEncoder().encodeToString(Utils.randomString(30).getBytes());
    private static final long JWT_EXPIRATION_DEV = 365 * 24 * 60 * 60 * 1000L;
    private static final long JWT_EXPIRATION_PROD = 1 * 24 * 60 * 60 * 1000L;
